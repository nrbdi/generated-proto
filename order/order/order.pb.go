...
const file_order_order_proto_rawDesc = "" +
	"\n" +
	"\x11order/order.proto\x12\border.v1\x1a\x1fgoogle/protobuf/timestamp.proto\")\n" +
	...
	"\n" +
	"updated_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAt2`\n" +
	"\fOrderService\x12P\n" +
	"\x17SubscribeToOrderUpdates\x12\x16.order.v1.OrderRequest\x1a\x1b.order.v1.OrderStatusUpdate0\x01B(Z&github.com/nrbdi/generated-proto/orderb\x06proto3"
